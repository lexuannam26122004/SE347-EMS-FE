                ...
                >
                    <Table>
                        <TableBody>
                            {[
                                {
                                    label: t(`COMMON.TIMEOFF.EMPLOYEEID`),
                                    value: t(String(configuration?.EmployeeId)) || 'N/A'
                                },
                                {
                                    label: t(`COMMON.TIMEOFF.FULLNAME`),
                                    value: t(String(configuration?.FullName)) || 'N/A'
                                },
                                {
