...
const Reward: React.FC<EmployeeProps> = ({ aspnetUserId }) => {
    ...
    const users: User[] = [
        { Id: '1', Reason: 'Đi trễ', Money: -200, Note: 'Đi làm muộn 3 lần trong tháng' },
        { Id: '2', Reason: 'Không hoàn thành công việc', Money: -500, Note: 'Không đạt chỉ tiêu công việc' },
        { Id: '3', Reason: 'Nghỉ không phép', Money: -300, Note: 'Nghỉ làm mà không thông báo trước' },
        { Id: '4', Reason: 'Vi phạm nội quy', Money: -400, Note: 'Sử dụng điện thoại trong giờ họp' },
        { Id: '5', Reason: 'Thái độ làm việc', Money: -600, Note: 'Thái độ không hợp tác với đồng nghiệp' }
    ]
                ...
                >
                    <Table>
                        <TableHead>
                            ...
                            >
                                {['Id', 'Lí do', 'Số tiền nộp phạt', 'Ghi chú'].map((column, index) => (
