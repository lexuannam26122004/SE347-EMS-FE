            ...
            >
                ...
                >
                    <Table>
                        <TableBody>
                            {[
                                { label: 'Nhân viên', value: reward.FullName },
                                { label: 'Phòng ban', value: reward.Department },
                                { label: 'Ngày', value: formatDate(reward.Date) },
                                { label: 'Lý Do', value: reward.Reason },
                                {
                                    label: 'Ghi chú',
                                    value: reward.Note
                                },
                                { label: 'Số tiền thưởng', value: reward.Money },
                                { label: 'Trạng thái', value: reward.IsReceived ? 'Đã nhận' : 'Chưa nhận' }
                            ].map((item, index) => (
                                <TableRow key={index}>
                                    <TableCell
                                        sx={{
